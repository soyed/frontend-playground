...
const priceSliderImg = document.querySelector('.slider-container img');
...
priceSliderImg.addEventListener('mouseup', () => (mousedown = false));
priceSliderImg.addEventListener('mousedown', () => (mousedown = true));

priceTrack.addEventListener('mousemove', (event) => {
  // console.log(event);
  console.log(mousedown);
  console.log(priceFill.clientWidth, event.offsetX, priceTrack.clientWidth);
});
